...
export default async function AdviserDashboardPage() {
  ...
  if (!user || user.accountType !== "adviser") redirect("/login");
  ...
  return (
    <div className="mx-auto max-w-[720px] px-7 py-16">
      ...
      <p className="mt-4 text-ink-2">
        This is the Stage-1 foundation stub for the adviser workspace
        (orders, service packages, messages, earnings, verification status).
