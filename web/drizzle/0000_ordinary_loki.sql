...
CREATE TABLE "scholarship" (
	...
	"applications_per_year_label" text,
	"places_available_label" text,
	...
	"gpa_requirement_max_german" numeric(3, 2),
	"work_experience_requirement" text,
	"work_experience_min_years" numeric(4, 1),
	"required_documents" jsonb DEFAULT '[]'::jsonb NOT NULL,
	"open_date" date,
	"close_date" date,
	"is_rolling_deadline" boolean DEFAULT false NOT NULL,
	"important_dates_extra" jsonb DEFAULT '[]'::jsonb NOT NULL,
	"study_location_label" text,
	"application_method_label" text,
	"application_process_note" text,
	"application_steps" jsonb DEFAULT '[]'::jsonb NOT NULL,
	"application_process" text,
	"official_application_url" text,
	"official_sources" jsonb DEFAULT '[]'::jsonb NOT NULL,
	"funding_breakdown" jsonb DEFAULT '[]'::jsonb NOT NULL,
	"funding_total_value_label" text,
	"funding_total_period_label" text,
